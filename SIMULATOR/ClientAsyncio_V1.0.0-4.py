...
async def clientGL(x):
    while 1:
        try:
            ...
            connect = asyncio.open_connection('192.168.130.13', 8080)
            ...
            if result == 'ICY 200 OK':
                ...
                B = random.randrange(0, 1000, 1) / 100 + 3103.14747523
                L = random.randrange(0, 1000, 1) / 100 + 12121.33538519
