...
class RTCM:
    ...
    def MSM4(self, data, rtcmtype):
        ...
        for k in list(dic.keys()):
            ...
            # dic_result[key[k]] = Tool.compress_json_data(df_sat_sig, 0)
    ...
    def rtcm1005(self, data):
        ...
        dic_result = {
            ...
            "GNSS系统": Tool.gnss_system_server(gnss)
        }
        # print(dic_result)
        return dic_result
    ...
    def rtcm1033(self, data):
        ...
        for i in range(4):
            cr1 = cr(rdata)
            dic_result[li[i]] = cr1.Getcontent()
